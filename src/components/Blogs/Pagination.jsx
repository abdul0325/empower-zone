    ...
    <div className="container mx-auto px-4 pb-16">
      <nav className="flex justify-center">
        <ul className="inline-flex items-center -space-x-px">
          ...
          <li>
            <a href="#" className="px-3 py-2 leading-tight text-white bg-[#A48E66] border border-gray-300 0 hover:text-gray-700">1</a>
          </li>
          <li>
            <a href="#" className="px-3 py-2 leading-tight  text-gray-700 border border-gray-300">2</a>
          </li>
          <li>
