...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: Phone, label: "+1 (718) 757-6928", href: "+1 (718) 757-6928" },
    { icon: Phone, label: "+1 (718) 757-6928", href: "+1 (718) 757-6928" },
    { icon: Mail, label: "empowerzoneservices@gmail.com", href: "empowerzoneservices@gmail.com" },
    { icon: Globe, label: "www.empowerZone.com", href: "www.empowerZone.com" },
    { icon: MapPin, label: "USA , Washington  Building  No.1 Third Floor ", href: "#" }
  ];
  ...
  return (
    <>
      ...
      <footer className="relative bg-gradient-to-br from-[#b7e9dc] via-[#99b9b2] to-[#616564] overflow-hidden">
              ...
              <Link href="/" className="flex items-center space-x-3 group">
                <div className="relative">
                  <img 
                    ...
                    className="w-40 h-20 object-contain transform group-hover:scale-110 transition-all duration-300"
                  />
                </div>
